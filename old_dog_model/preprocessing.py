...
class Preprocessing:
    ...
    def not_found_words(embedding_matrix, vocabulary):
        '''      
...
# nonzero_elements, not_foundWords, not_foundIndex = Preprocessing.not_found_words(embedding_matrix)
