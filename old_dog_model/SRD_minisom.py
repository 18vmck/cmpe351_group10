# -*- coding: utf-8 -*-
"""
Created on Sun May 24 22:00:11 2020
...
class MiniSom(object):
    def __init__(self, x, y, input_len, sigma=1.0, learning_rate=0.5, 
        ...
        if decay_function:
            ...
            self._decay_function = lambda x, t, max_iter: x/(1+t/max_iter)# self.sigma, t, self.T
    ...
    def win_distanc(self, x):
        """ Computes the coordinates of the winning neuron for the sample x """
        self._activate(x)
    
        return self.activation_map.min()
...
#=================================================================================================================
    def update(self, x, win, t):
        ...
        #if (t % 1000) == 0 :
        #if (t == 0) or (t == 5000 ):
        #    print('iteration', t, 'eta', eta, 'sig', sig)
...
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    def _init_T(self, num_iteration):
        ...
        self.T = num_iteration/ self.sigma # keeps the learning rate nearly constant for the last half of the iterations
    ...
    def distance_map(self):
        ...
        while not it.finished:
            ...
            um[it.multi_index] = um[it.multi_index] / (neighbor_counts - 1)            
            it.iternext()
        um = um/um.max()
        return um
